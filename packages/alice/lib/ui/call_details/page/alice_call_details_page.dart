...
class _AliceCallDetailsPageState extends State<AliceCallDetailsPage>
                  ...
                  floatingActionButton: Column(
                    ...
                    children: [
                      FloatingActionButton(
                        ...
                        key: const Key('curl_copy_key'),
                        heroTag: 'curl_copy',
                        onPressed: _copyCurl,
                        tooltip: 'cURL kopyala',
                        child: const Icon(
                          Icons.content_copy,
                          color: AliceTheme.white,
                        ),
                      ),
                      if (widget.core.configuration.showShareButton) ...[
  ...
  /// Copies the cURL command for [widget.call] to clipboard and shows a snackbar.
  void _copyCurl() async {
    final curlCommand = Curl.getCurlCommand(widget.call);
    await Clipboard.setData(ClipboardData(text: curlCommand));
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('cURL komutu kopyalandı'),
